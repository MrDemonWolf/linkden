...
const cardVariants = cva("rounded-lg text-[var(--ld-card-foreground)] transition-colors", {
	variants: {
		variant: {
			elevated: "bg-[var(--ld-card)] shadow-md",
			outlined: "border border-[var(--ld-border)] bg-[var(--ld-card)]",
			flat: "bg-[var(--ld-card)]",
		},
		padding: {
			sm: "p-3",
