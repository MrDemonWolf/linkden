...
Toggle the contact form on or off. When disabled, the form is hidden from the public page and the API endpoint returns a 404.
...
Toggle Cloudflare Turnstile CAPTCHA on or off for the contact form. Requires Turnstile site key and secret key in your environment variables.
