...
1. Go to [Zero Trust](https://one.dash.cloudflare.com) in the Cloudflare dashboard.
...
See the [Authentication guide](/docs/api/authentication) for detailed instructions, Clerk setup, or using both providers together.
