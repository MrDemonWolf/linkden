...
2. **Node.js 20+** and **[Bun](https://bun.sh)** installed locally.
...
Once you have your real Worker URLs, update the `NEXT_PUBLIC_SERVER_URL`, `CORS_ORIGIN`, and `BETTER_AUTH_URL` values in `.env` and run `bun ship` again.

## Step 6: Create Your Admin Account

LinkDen uses **Better Auth** with email/password.

1. Visit `https://linkden-web.<your-subdomain>.workers.dev/admin/setup` in your browser.
2. Enter your name, email, and password to create your admin account.
3. The first user becomes the admin and registration locks automatically -- no one else can sign up.
