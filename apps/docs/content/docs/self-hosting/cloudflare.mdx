...
5. Under **Account Resources**, select your account. Under **Zone Resources**, select the zone that will host your site (or all zones).
...
`ALCHEMY_STAGE` separates deployments of the same app. It defaults to `prod`; set it to `dev` for a throwaway staging copy.
