...
| API | `linkden-server.your-subdomain.workers.dev` | `api.yourdomain.com` |
...
Update your `.env` file with the custom domain URLs:
...
| Type | Name | Target | TTL |
|------|------|--------|-----|
| CNAME | `api` | `linkden-server.your-subdomain.workers.dev` | Auto or 300 |
