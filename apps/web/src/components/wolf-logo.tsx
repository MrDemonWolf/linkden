...
// LinkDen wolf mark — our derivative of the CC0 "Wolf head Pinhead icon"
// (Wikimedia Commons, public domain): re-weighted with a rounded stroke for a
// bolder, friendlier head that stays crisp at 16px, in brand cerulean #00ACED.
export function WolfLogo({ className }: WolfLogoProps) {
	return (
		<svg
			xmlns="http://www.w3.org/2000/svg"
			viewBox="-0.75 -0.75 16.5 16.5"
			className={className}
			aria-hidden="true"
		>
			<path
