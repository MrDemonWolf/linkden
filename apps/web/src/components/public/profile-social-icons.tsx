...
export function ProfileSocialIcons({ networks, colorMode, themeColors }: ProfileSocialIconsProps) {
	...
	return (
		<nav
			className="ld-social-icons mt-5 flex flex-wrap items-center justify-center gap-2.5"
			...
			{networks.map((network) => {
				...
				return (
					<a
						...
						className="inline-flex items-center justify-center h-10 w-10 rounded-full transition-all duration-300 hover:scale-110 hover:-translate-y-0.5 min-h-[44px] min-w-[44px] focus-visible:outline-2 focus-visible:outline-offset-2"
						style={{
