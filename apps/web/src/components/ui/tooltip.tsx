...
/**
 * Convenience for the common "icon button with a hover hint" case. `children`
 * must be a single focusable element; it is rendered as the trigger itself.
 * Keep an `aria-label` on the trigger — the tooltip is a visual hint only.
 */
