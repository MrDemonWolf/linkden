...
function DropdownMenuTrigger({ className, ...props }: React.ComponentProps<typeof MenuButton>) {
	return (
		<MenuButton
...
function DropdownMenuGroup({ className, ...props }: React.ComponentProps<typeof MenuSection>) {
	return <MenuSection as="div" data-slot="dropdown-menu-group" className={className} {...props} />;
}
