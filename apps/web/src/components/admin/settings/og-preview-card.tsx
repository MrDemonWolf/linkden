 ...
 */
export function OgPreviewCard({ title, description, imageUrl, siteUrl }: OgPreviewCardProps) {
	const displayTitle = title || "Your Page Title";
	const displayDescription = description || "A short description of your page will appear here.";
