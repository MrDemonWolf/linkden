...
export default function FormsPage() {
	...
	useEffect(() => {
		...
		// biome-ignore lint/correctness/useExhaustiveDependencies: invalidate is recreated every render; the guarded init only needs to react to the selected contact
		invalidate,
		selectedContact?.id,
				...
				{contactsQuery.isLoading ? (
					...
					<div className="flex gap-4">
						...
						<Card className="flex-1 min-w-0 overflow-hidden">
							<ul className="divide-y" aria-label="Form submissions">
